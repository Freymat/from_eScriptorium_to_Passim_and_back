...
GT_texts_directory_path = os.path.join(
    project_root, "data", "raw", "digital_editions")
...
output_passim_path = os.path.join(
    project_root, "data", "processed", "passim_output")
...
xmls_for_eSc_path = os.path.join(
    project_root, "data", "output", "xmls_for_eSc")
