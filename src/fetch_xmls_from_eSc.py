...
from credentials import root_url, headers, headersbrief

from config import (
    region_type_pk_list,
    transcription_level_pk,
)
...
def initiate_xml_export(doc_pk):
    ...
    print(
        f"XMLs export initiated. Please download the XMLs from your eScriptorium instance ({root_url}) and unzip them in the 'data/raw/xmls_from_eSc' folder."
    )